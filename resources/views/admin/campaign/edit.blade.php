@extends('layouts.app' , ['title' => 'Edit - Page Admin'])
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="mx-auto container py-6 px-8">
            <div class="p-6 bg-white rounded-md shadow-md">
                <div><span class="font-bold text-gray-600 text-2xl">Edit Campaign</span></div>
                <hr class="mt-2 mb-4">
                <form action="{{ route('admin.campaign.update',  $campaign->id )}}" method="POST" enctype="multipart/form-data">
                    ...
                    <label class="block mb-3" for="">
                        ...
                        <input type="text" name="title" class="bg-gray-100 outline-none form-input mt-1 block w-full rounded-md focus:bg-white" id="" value="{{ old('title', $campaign->title) }}">
                        @error('title')
                            <div class="w-full bg-red-300 shadow-md rounded-md overflow-hidden mt-2">
                                <div class="px-4 py-2">
                                    <p class="text-gray-600 text-sm">{{$message}}</p>
                    ...
                    <label class="block mb-3" for="">
                        ...
                        <textarea name="description" class="bg-gray-100 form-input mt-1 p-3 block w-full rounded-md focus:bg-white"  id="">{{ old('description' ,$campaign->description) }}</textarea>
                        @error('description')
                        <div class="w-full bg-red-300 shadow-md rounded-md overflow-hidden mt-2">
                            <div class="px-4 py-2">
                                <p class="text-gray-600 text-sm">{{$message}}</p>
                    ...
                    <label class="block mb-3" for="">
                        ...
                        <input type="text" name="target_donation" class="bg-gray-100 outline-none form-input mt-1 block w-full rounded-md focus:bg-white" id="" value="{{ old('target_donation', $campaign->target_donation) }}">
                    ...
                    <label class="block mb-3" for="">
                        ...
                        <input type="date" name="max_date" class="bg-gray-100 outline-none form-input mt-1 block w-full rounded-md focus:bg-white" id="" value="{{ old('max_date', $campaign->max_date) }}">
                        @error('max_date')
                            <div class="w-full bg-red-300 shadow-md rounded-md overflow-hidden mt-2">
                                <div class="px-4 py-2">
                                    <p class="text-gray-600 text-sm">{{$message}}</p>
