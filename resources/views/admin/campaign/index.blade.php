                        ...
                        @forelse($campaigns as $campaign)
                            <tr class="border bg-white">
                                ...
                                <td class="px-10 py-2 text-center">
                                    ...
                                    <button id="{{$campaign->id}}" onclick="destroy(this.id)" class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                                </td>
                            </tr>
                        @empty
